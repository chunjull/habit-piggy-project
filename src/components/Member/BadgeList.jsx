  ...
  return (
    <div className="relative space-y-4 rounded-2xl bg-black-50 px-4 pb-4 pt-9 dark:bg-black-800">
      {isLoading ? (
        <div className="animate-pulse space-y-4">
          <div className="grid grid-cols-6 gap-4">
            <div className="mx-auto aspect-square h-fit w-1/2 rounded-full bg-black-200"></div>
            <div className="mx-auto aspect-square h-fit w-1/2 rounded-full bg-black-200"></div>
            <div className="mx-auto aspect-square h-fit w-1/2 rounded-full bg-black-200"></div>
            <div className="mx-auto aspect-square h-fit w-1/2 rounded-full bg-black-200"></div>
            <div className="mx-auto aspect-square h-fit w-1/2 rounded-full bg-black-200"></div>
      ...
      <div className="absolute -top-12 left-1/2 w-[150px] -translate-x-1/2 transform bg-primary px-4 py-1">
        ...
        <div className="absolute before:absolute before:bottom-[-16px] before:left-[-16px] before:z-20 before:h-0 before:w-0 before:border-l-[20px] before:border-r-0 before:border-t-[13px] before:border-l-primary before:border-r-transparent before:border-t-primary-dark before:content-['']"></div>
        <div className="absolute before:absolute before:bottom-[-16px] before:left-[114px] before:z-20 before:h-0 before:w-0 before:border-l-0 before:border-r-[20px] before:border-t-[13px] before:border-l-transparent before:border-r-primary before:border-t-primary-dark before:content-['']"></div>
