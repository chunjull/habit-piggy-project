...
const PostForm = ({ userData, backgrounds, postBackground, setPostBackground, postContent, setPostContent, handleAddPost, calculateTextColor, isHighlighted, handleClick, postRef }) => {
  return (
