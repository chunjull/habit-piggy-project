...
const TopTenUsersList = ({ userCounts, type, calculateLevelAndPoints, isLoading }) => {
            ...
            <div className="animate-pulse flex justify-between items-center w-full">
              <div className="flex items-center gap-4">
                ...
                <div className="flex flex-col gap-1 w-60">
                  <div className="w-1/2 h-6 bg-black-200 rounded-lg"></div>
                  <div className="w-1/3 h-5 bg-black-200 rounded-lg"></div>
                </div>
              </div>
              <div className="flex flex-col items-end gap-1 w-60">
                <div className="w-1/2 h-5 bg-black-200 rounded-lg"></div>
                <div className="w-1/3 h-6 bg-black-200 rounded-lg"></div>
              </div>
            </div>
          </li>
        ))}
