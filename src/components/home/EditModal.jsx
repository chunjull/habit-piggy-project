    ...
    <div className="space-y-4">
      ...
      <div className="space-y-2">
        ...
        <div className="grid grid-cols-2 gap-4">
          <button
            className="w-full rounded-lg bg-alert py-1 text-sm font-normal leading-5 text-white"
            onClick={() => {
          ...
          <button
            className="w-full rounded-lg bg-primary py-1 text-sm font-normal leading-5 hover:bg-primary-dark"
            onClick={(event) => {
